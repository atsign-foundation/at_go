...
### Prerequisites
   ...
   Download the latest version of Go from https://go.dev/
...
1. Fork in GitHub https://github.com/atsign-foundation/at_go
2. Clone *your forked repository* (e.g., `git clone git@github.com:yourname/at_go`)
3. Set your remotes as follows:

   ```sh
   cd at_go
   git remote add upstream git@github.com:atsign-foundation/at_go.git
   ...
   ```text
   origin  git@github.com:yourname/at_go.git (fetch)
   origin  git@github.com:yourname/at_go.git (push)
   upstream        git@github.com:atsign-foundation/at_go.git (fetch)
